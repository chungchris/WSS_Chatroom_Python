...
class UserBook:
    ...
    def _load(self):
        ...
        try:
            ...
            # TODO: if decry fail. rename the old one and create an new user book
            ...
            async for message in websocket:
                ...
                ### login ###
                    ...
                    if len(data[settings.JSON_KEY_NAME])<0 or len(data[settings.JSON_KEY_PASSWORD])<0:
                        ...
                        await asyncio.wait([websocket.send(res)])
                    # TODO: check amount of login user below ONLINE_USER_MAX_AMOUNT
                ...
                # wonn't lead to auto login
                    ...
                    if len(data[settings.JSON_KEY_NAME]) < 0 \
                        ...
                        await asyncio.wait([websocket.send(res)])
                    # TODO: check amount of registered user below RESISTERED_USER_MAX_AMOUNT
